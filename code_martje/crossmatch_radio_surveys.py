...
os.system('java -jar topcat-full.jar -stilts \
          tmatchn matcher=sky multimode=pairs nin=6 params=15 \
    ...
    in6=C:\\Users\\Femke\\Documents\\GitHub\\master_project_1\\data\\surveys\\inband_spec_LoTSS.fits values6="RA DEC" \
