...
#TODO: je zou kunnen overwegen de derde bin in 2 op te splitsen
idx1 = [0,0,1,1,2,2]
idx2 = [0,1,0,1,0,1]
# bin_size = [0.8,0.4,0.4,0.5,0.6,0.2]
# bin_size_PS = [1.,1.4,0.6,0.8,1.,0.8]
#TODO: Play around with binsizes until you find something you like
bin_size = [0.3,0.2,0.2,0.3,0.6]
bin_size_PS = [0.6,0.6,0.15,0.6,0.7]
...
#TODO: These will be send by Martje soon
#Kondapally 2022
...
for index, z_bin_min in enumerate(redshift_bins[:-2]):
    ...
    if index != 5:
        ...
        ax1.set_xlim(22.5,33)
        ax1.set_ylim(-0.15,2.9)
        ax1.legend()
