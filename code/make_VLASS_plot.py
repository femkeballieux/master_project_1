...
plt.hist(NN[mask1], bins=bin_edges, histtype='step', label='all')
...
plt.ylabel('n')
plt.xlabel('Distance to nearest neighbour in arcsec')
plt.xscale('log')
#plt.vlines(2.9, 0, 62000, label='typical VLASS beam size', linestyle='dotted')
plt.vlines(47, 0, 62000, label='isolation criterium', linestyle='dashed')
