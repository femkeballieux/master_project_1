...
def crossmatching1():
    """
    Crossmatching is done seperately for LoTSS-NVSS with VLASS, since VLASS has a higher resolution.
    params=3 arcsec
    """
...
"""
#S_match2 is a mask for the sources that have nonzero fluxes for lotss nvss vlass
...
#here we write it to S_match2 so the right alphas get written to the right sources
