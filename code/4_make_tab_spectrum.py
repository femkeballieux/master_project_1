...
takes in the corssmatched file, determines the alpha high and low, and writes only the relevant data to a new file. (master sample)
"""
#Run on vdesk
import numpy as np
...
#if any column names change, change them here
...
Name = tbdata['NVSS'].rstrip()
RA = tbdata['RA_1']
DEC = tbdata['DEC_1']

#we do not use first, nvss is our main sample
NVSS = True
